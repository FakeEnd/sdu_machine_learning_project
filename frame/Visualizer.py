...
class Visualizer():
    ...
    def draw_train_test_curve(self):
        import torch
        # torch.save({'test_loss_record':self.test_loss_record, 'step_test_interval': self.step_test_interval},
        #            './6_adv.pth'
        #            )
        print(self.test_loss_record)
        print(self.step_test_interval)
    ...
    def draw_tsne(self):
        ...
        plt.title('t-SNE Visualisation '.format(self.config.kmer), fontdict=font)
